...
const BuyNowFormModal = ({ modalData }) => {
  return (
        ...
        <div className="flex flex-col gap-4 mt-5">
          ...
          <label>
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5 outline-none hover:cursor-not-allowed"
            />
          </label>
...
function CourseDetails() {
  ...
  const handleBuyCourse = () => {
    if (token) {
      ...
      setIsBuyFormVisible({
        text1: "You will receive a mail on registered email",
        btn1Text: "Send Email",
        btn2Text: "Cancel",
        email,
        firstName,
        lastName,
        btn1Handler: () => buyCourse(token, courseId, email, firstName, lastName, navigate, dispatch),
        btn2Handler: () => setIsBuyFormVisible(null),
      })
    }
    else {
  ...
  return (
    <>
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-cente py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="mb-5 lg:mt-10 lg:mb-0 z-[100]  " onClick={() => navigate(-1)}>
              <GiReturnArrow className="w-10 h-10 text-purple-800 hover:text-purpleHome / Catalog -50 cursor-pointer" />
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {
                tag && tag.map((item, ind) => (
                  <p key={ind} className="text-white bg-purple-800 p-[5px] rounded-full text-center font-semibold" >
                    {item}
                  </p>
                ))
              }
      ...
      {isBuyFormVisible && <BuyNowFormModal modalData={isBuyFormVisible} />}
    </>
  )
}
