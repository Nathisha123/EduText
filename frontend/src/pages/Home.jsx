        ...
        <div className='px-5 sm:px-10 '>
            ...
            <div className='my-[80px] relative mx-auto flex flex-col gap-3 justify-center  items-center text-white '>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-5 mt-7'>
                    ...
                    <InstructorCard name='Om raje' role='Career Educator' icon={DiAndroid}  profileImg={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXDJlI2rXCa2rDXJ_Ct7E-zPYL5Uw5K55dXA&s"}/>
